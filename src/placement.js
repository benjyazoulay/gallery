...
module.exports = (regl, {placements, getAreaIndex}) => {
    ...
    const loadPainting = (p) => {
        ...
        if (!user) {
            console.error("Aucun utilisateur connecté. Impossible de charger les peintures.");
            return; // Sortir si l'utilisateur n'est pas authentifié
        }
        console.log("Début loadPainting:");
        ...
        auth.onAuthStateChanged(async (user) => {
            if (user) {
                ...
                // Appeler texture.fetch après que l'utilisateur soit authentifié
